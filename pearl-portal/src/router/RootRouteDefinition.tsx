...
export const RootRouteDefinition: RouteDefinition = {
    path: '', children: [{
        path: '/', name: 'Home', page: LandingPage, icon: HomeIconComponent, isChildren: false, showInMenu: true
    },
    {
        path: '/lpsOverview', name: 'LPs', icon: LPIconComponent, page: LPsOverview, isChildren: false, showInMenu: true
    },
    {
        path: '/lpsOverview/singleLP', name: 'Single LP', icon: SingleLPIconComponent, page: SingleLPPage, isChildren: true, showInMenu: false
    },
    {
        path: '/fundsOverview', name: 'Funds', page: FundsOverview, icon: FundsMenuIcon, isChildren: false, showInMenu: true
    }, {
        path: '/fundsOverview/singleFund', name: 'Single Fund', icon: SingleFundIconComponent, page: SingleFundPage, isChildren: true, showInMenu: false
    },
    {
        path: '/pcosOverview', name: 'PCOs', page: PCOsOverview, icon: BusinessIconComponent, isChildren: false, showInMenu: true
    },
    {
        path: '/pcosOverview/singlePCO', name: 'Single PCO', icon: SinglePCOIconComponent, page: SinglePCOPage, isChildren: true, showInMenu: false
    },
    {
        path: '/settings', name: 'Settings', page: Settings, icon: SettingsIconComponent, isChildren: false, showInMenu: true
    }]
};
