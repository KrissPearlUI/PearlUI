...
const PCOsDownloadDialogContentComponent = () => {
    ...
    const onFundChange = (event: React.SyntheticEvent, value: FundSummary | null) => {
    ...
    return (
        <Grid container spacing={2}>
            <Grid item>
                <Typography variant='body2'>Select a Fund</Typography>
...
export default PCOsDownloadDialogContentComponent;