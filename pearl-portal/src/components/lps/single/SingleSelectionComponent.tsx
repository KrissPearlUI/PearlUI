import { Button, ButtonGroup, Fab, Grid, IconButton, InputAdornment, TextField } from '@mui/material';
        ...
        <Grid container spacing={1} sx={{ display: 'flex', flex: 1, justifyContent: 'space-betweeen', alignItems: 'flex-start', flexDirection: 'row', width: '100%' }}>
            <Grid item xs={8} md={8} lg={8}>
                <ButtonGroup variant="outlined" aria-label="outlined primary button group" sx={{ height: 36 }}>
                    ...
                    <Button sx={{
                        fontSize: 12, backgroundColor: selectedItem === 'commitments' ? theme.palette.primary.main : theme.palette.background.paper,
                        color: selectedItem === 'commitments' ? 'white' : theme.palette.primary.main
                    }} onClick={() => handleButtonClick('commitments')}>
                        Commitments</Button>
                    <Button sx={{
                        fontSize: 12, backgroundColor: selectedItem === 'coinvestments' ? theme.palette.primary.main : theme.palette.background.paper,
                    ...
                    <Button sx={{
                        fontSize: 12, backgroundColor: selectedItem === 'portfolio' ? theme.palette.primary.main : theme.palette.background.paper,
                        color: selectedItem === 'portfolio' ? 'white' : theme.palette.primary.main
                    }} onClick={() => handleButtonClick('portfolio')}>
                        Portfolio</Button>
                    <Button sx={{
                        fontSize: 12, backgroundColor: selectedItem === 'callsDist' ? theme.palette.primary.main : theme.palette.background.paper,
                    ...
                    <Button sx={{
                        fontSize: 12, backgroundColor: selectedItem === 'transactions' ? theme.palette.primary.main : theme.palette.background.paper,
                        color: selectedItem === 'transactions' ? 'white' : theme.palette.primary.main
                    }} onClick={() => handleButtonClick('transactions')}>
                        Transactions</Button>
                    <Button sx={{
                        fontSize: 12, backgroundColor: selectedItem === 'documents' ? theme.palette.primary.main : theme.palette.background.paper,
